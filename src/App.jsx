    ...
    <div style={{ position: "relative", padding: "10px 0" }}>
      <style>{`
        .${cls} {
          ...
          outline: none; cursor: pointer;
          background: linear-gradient(to right, ${accentColor} ${pct}%, rgba(30,10,0,0.15) ${pct}%);
        }
        ...
        .${cls}:hover::-webkit-slider-thumb,
        .${cls}:active::-webkit-slider-thumb { opacity: 1; transform: scale(1.1); }
...
function JournalGlassCard({ children, style = {} }) {
  return (
    <div style={{
    ...
    <div style={{ minHeight: "100vh", position: "relative" }}>
      <style>{`
        ...
        .j-bg {
          ...
          background-image: url("${JOURNAL_BG}");
        ...
        .j-title {
          ...
          font-size: 38px; color: #fff; letter-spacing: -0.5px; line-height: 1.05;
        ...
        .j-tabs {
          ...
          background: rgba(200,190,185,0.28);
          backdrop-filter: blur(50px) saturate(160%) brightness(1.08);
          -webkit-backdrop-filter: blur(50px) saturate(160%) brightness(1.08);
        ...
        .j-tab {
          ...
          color: rgba(20,6,0,0.38);
        }
        .j-tab.active {
          background: rgba(255,255,255,0.5);
          color: rgba(20,6,0,0.85);
          font-weight: 700;
        ...
        textarea.j-ta {
          ...
          border: none; border-bottom: 1.5px solid rgba(20,6,0,0.12);
          border-radius: 0; padding: 10px 0;
          color: rgba(20,6,0,0.88); font-size: 15px; resize: none; outline: none;
        ...
        .j-save {
          ...
          background: rgba(200,190,185,0.3);
          backdrop-filter: blur(50px) saturate(160%) brightness(1.08);
          -webkit-backdrop-filter: blur(50px) saturate(160%) brightness(1.08);
          border: 0.5px solid rgba(255,255,255,0.28);
          color: rgba(20,6,0,0.82); font-size: 15px; font-weight: 700;
        ...
        .j-chip {
          ...
          border-radius: 12px; border: 0.5px solid rgba(255,255,255,0.25);
      ...
      <div className="j-content">
        ...
        <div className="j-tabs">
          {[{ key: "checkin", label: "Today" }, { key: "history", label: "History" }].map(t => (
            <button key={t.key} className={`j-tab ${tab === t.key ? "active" : ""}`} onClick={() => setTab(t.key)}>
              {t.label}
            </button>
          ))}
        </div>
          ...
          <div style={{ padding: "18px 20px 0" }}>
            ...
            <JournalGlassCard>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 2 }}>
                ...
                <span style={{ fontSize: 22, fontWeight: 700, letterSpacing: -0.5, fontVariantNumeric: "tabular-nums", color: workColor }}>
            ...
            <JournalGlassCard>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 2 }}>
                ...
                <span style={{ fontSize: 22, fontWeight: 700, letterSpacing: -0.5, fontVariantNumeric: "tabular-nums", color: sleepColor }}>
            ...
            <JournalGlassCard style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "14px 18px" }}>
              <div>
              ...
              <button onClick={() => set("social", !entry.social)} style={{
                ...
                fontSize: 13, fontWeight: 700, letterSpacing: 0.2, transition: "all 0.22s",
            ...
            <JournalGlassCard style={{ padding: "16px 18px" }}>
              <div style={{ fontSize: 11, color: TM, letterSpacing: 1.5, textTransform: "uppercase", fontWeight: 700, marginBottom: 8 }}>
                Reflections
              </div>
            ...
            <div style={{ marginTop: 4 }}>
              {saved ? (
                <div style={{
                  textAlign: "center", padding: "15px", borderRadius: 18,
                  background: "rgba(200,190,185,0.3)",
                  border: "0.5px solid rgba(255,255,255,0.28)",
                  backdropFilter: "blur(50px) saturate(160%) brightness(1.08)",
                  color: "#14532d", fontSize: 14, fontWeight: 700,
                  boxShadow: "0 2px 12px rgba(0,0,0,0.08)",
                }}>✓  Saved</div>
              ) : (
          ...
          <div style={{ padding: "18px 20px 0" }}>
            {mentalLogs.length === 0 ? (
              <div style={{ textAlign: "center", padding: "80px 20px" }}>
                ...
                <div style={{ fontSize: 15, color: "#fff", fontWeight: 600, marginBottom: 6, textShadow: "0 1px 8px rgba(0,0,0,0.25)" }}>No entries yet</div>
                <div style={{ fontSize: 13, color: "rgba(255,255,255,0.65)" }}>Your first entry will appear here.</div>
              </div>
            ) : mentalLogs.map(log => (
